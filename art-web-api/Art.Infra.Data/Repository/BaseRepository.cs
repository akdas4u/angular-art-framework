namespace Art.Infra.Data.Repository
{
    ...
    {
        protected readonly ArtContext Db;
        ...
        ///     Todas as entidades que condizem com a regra informada.
        /// </returns>
        public virtual IQueryable<TEntity> GetBy(IQueryable<TEntity> query, Func<TEntity, bool> predicate)
        {
        ...
        ///     Todas as entidades que condizem com a regra informada.
        /// </returns>
        public virtual IQueryable<TEntity> GetBy(Func<TEntity, bool> predicate, params Expression<Func<TEntity, object>>[] includes)
        {
        ...
        ///     Todas as entidades que condizem com a regra informada.
        /// </returns>
        public virtual IQueryable<TEntity> GetBy(Func<TEntity, bool> predicate, params string[] includes)
        {
            var query = this.GetAll();
