namespace Art.Domain.Interfaces
{
        ...
        where TEntity : BaseEntity
    {
        ...
        ///     Todas as entidades que condizem com a regra informada.
        /// </returns>
        IQueryable<TEntity> GetBy(IQueryable<TEntity> query, Func<TEntity, bool> predicate);
        ...
        ///     Todas as entidades que condizem com a regra informada.
        /// </returns>
        IQueryable<TEntity> GetBy(Func<TEntity, bool> predicate, params Expression<Func<TEntity, object>>[] includes);
        ...
        ///     Todas as entidades que condizem com a regra informada.
        /// </returns>
        IQueryable<TEntity> GetBy(Func<TEntity, bool> predicate, params string[] includes);
