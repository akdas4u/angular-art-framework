...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  public ngOnInit() {
     ...
     const optionsDailySalesChart = {
          ...
          low: 0,
          high: 50, // ART: we recommend you to set the high sa the biggest value + something for a better look
      ...
      const optionsCompletedTasksChart = {
          ...
          low: 0,
          high: 1000, // ART: we recommend you to set the high sa the biggest value + something for a better
          // look
          chartPadding: { top: 0, right: 0, bottom: 0, left: 0}
      };
